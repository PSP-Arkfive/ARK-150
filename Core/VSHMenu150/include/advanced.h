...
#define SUBITEM_UNSUPPORTED 29

#define SUBITEM_USBDEVICE 30
#define SUBITEM_USBDEVICE_END 32

#define SUBITEM_NONE 33

#define SUBITEM_COLOR 38
#define SUBITEM_COLOR_END 66
