...
#define SUBITEM_UNSUPPORTED 28

#define SUBITEM_USBDEVICE 29
#define SUBITEM_USBDEVICE_END 31

#define SUBITEM_NONE 32

#define SUBITEM_COLOR 37
#define SUBITEM_COLOR_END 65
